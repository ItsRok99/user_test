...
async def sendStatistics(data):
    try:
        response = requests.post('https://add-statistic-d4d0de19d5ef.herokuapp.com/add-statistic', data)
        print(response.json())
...
client = MongoClient("mongodb+srv://nikkljucevsek:OldbtLLbshDbB69v@cluster0.9uuzozi.mongodb.net/", tlsCAFile=ca)
